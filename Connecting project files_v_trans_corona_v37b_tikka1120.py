...
# but perfectly ok for PCs and smaller data. Pauli Tikka et al. 5.3.2020/5.11.20 
#You may need to do the run of this code in Jupyter to work out, make sure that you have fast computer/s and good internet access!
...
start = datetime.datetime.strptime("2019-01-26", "%Y-%m-%d")
...
import time
import numpy as np
import winprocess # check the that this is in the right folder
from bs4 import BeautifulSoup
import alpine
#%
...
#%%HERE IS ANOTHER FILE 'winprocess.py', needed above:
import inspect
import types
from bs4 import BeautifulSoup
from selenium import webdriver  # for webdriver
